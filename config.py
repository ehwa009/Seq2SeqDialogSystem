...
tf.app.flags.DEFINE_integer("epoch", 7500, "총 학습 반복 횟수")

tf.app.flags.DEFINE_string("data_path", "./data/dialog.log", "대화 파일 위치")
tf.app.flags.DEFINE_string("voc_path", "./data/dialog.voc", "어휘 사전 파일 위치")
...
tf.app.flags.DEFINE_integer("max_decode_len", 30, "최대 디코더 셀 크기 = 최대 답변 크기.")
